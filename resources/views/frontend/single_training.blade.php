...
<meta property="og:image"         content="{{ asset('assets/img/profile.jpg') }}" />
@endsection
@section('content')
...
<br><br><br><br>
            ...
            <div class="page-header">
                <div class="container">
                    <div class="row schedule">
                        ...
                        <a href="#">Start On: {{ $training->start_date }}</a>
                        <a href="#">Completed On: {{ $training->end_date }}</a>
                        <a href="#">Session Duration : {{ $training->session_duration }}</a>
                        <a href="#">Class Schedule: {{ $training->class_schedule }}</a>
                        <a href="#">Total Class: {{ $training->total_classes }}</a>
                        </div>
            ...
            <!-- Page Header End -->
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Email this training to your friend</h5>
                      ...
                      <div class="modal-body">
                        <p>You can mail the training add of Compliance Training (BD) Limited to your friends & familiar person.</p>
                        <form method="post" action="{{ route('email_to_friend') }}">
                            @csrf
                            <input type="hidden" class="form-control" name="training" value="{{ $training->id }}">
                ...
                <div class="social_share text-center">
                    <a target="_blank" class="twitter-share-button" href="https://twitter.com/intent/tweet?url={{ url()->full() }}&text={{ $training->title }}">
                        ...
                        <div class="col-12">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="row">
                                        <div class="card">
                                          <h4 class="card-header text-center " style="background-color: black; color: white;">PRICE:&nbsp;BDT&nbsp;<span class="text-bold " style="font-weight: bold; font-size: 28px;">{{$training->price}}/-</span> </h4>
                                          <div class="card-body text-center">
                                            <a href="{{ route('join_training', $training->id) }}" class="btn btn-danger card-header" style="font-weight: bold; font-size: 28px; background-color: red; border:3px solid black; border-radius: 5px;">REGISTER HERE</a>
                                            <div class="text-center helpline"><br>
                                                <p class="text-center btn btn-primary" style="width:100%; background-color:black;">REGISTRATION HOTLINES</p>
