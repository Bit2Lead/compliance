      ...
      <div class="col-12 col-lg-9 col-xl-7">
        <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
          <div class="card-body p-4 p-md-5">
            <h3 class="mb-4 pb-5 pb-md-0 mb-md-5" style="text-align: center;background-color:black; padding-top:15px; padding-bottom: 15px !important; color:white;">Order The Book Here</h3>
